...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative w-full min-h-[calc(100vh+100px)] bg-background flex items-center justify-center text-center overflow-hidden"> {/* Alterado min-h para ser maior que a tela */}
